...
const NotesComponent = () => {
  ...
  return (
    <article  className={`transition-all ease-in-out duration-200 flex flex-col bg-white rounded-md shadow-xl p-2 ${notesComponentExpandState ? 'opacity-0 overflow-hidden' : 'opacity-100 w-[20rem] h-full flex-grow'}`}
    style={{
