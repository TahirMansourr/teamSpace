...
const IssuesComponent = () => {
    ...
    return (
    <article  className={`transition-all ease-in-out duration-200 flex flex-col  bg-white rounded-md shadow-sm p-2 ${issuesComponentExpandState ? 'opacity-0 overflow-hidden' : 'opacity-100 flex-grow w-[20rem] h-full'}`}
    style={{
