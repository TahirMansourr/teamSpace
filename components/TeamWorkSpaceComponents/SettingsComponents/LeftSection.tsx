...
const LeftSection = () => {
  return (
    <div className=" w-[50%]  h-[90%] bg-white  border-r border-gray-200 dark:border-gray-700 p-[3vh] space-y-[2vh]">
      <ScrollArea>
        <div className="space-y-[2vh]">
          ...
          <nav className="space-y-[2vh]">
            <div className="p-[3%] bg-gray-50  rounded-lg transition-all duration-200 hover:shadow-lg space-y-3">
            ...
            <div className="p-[3%] bg-gray-50  rounded-lg transition-all duration-200 hover:shadow-lg flex justify-between">
            ...
            <div className="p-[3%] bg-gray-50  rounded-lg transition-all duration-200 hover:shadow-lg">
              <h3 className="text-[clamp(0.9rem,1.5vw,1.2rem)] font-medium text-gray-600 dark:text-gray-300">
                Workspace Settings
              </h3>
            </div>
