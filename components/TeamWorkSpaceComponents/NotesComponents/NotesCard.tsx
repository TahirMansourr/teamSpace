...
const NotesCard = ({ Note }: { Note: NotesDto }) => {
  ...
  return (
    <div className=" w-[90%] mx-auto bg-gradient-to-br from-indigo-50 to-white rounded-xl shadow-sm border border-indigo-100 p-5 min-h-[15rem] flex flex-col justify-between">
      <div>
        ...
        >
          {isLoading ? (
            ...
            <div
              className="text-gray-600 leading-relaxed w-[100%]"
