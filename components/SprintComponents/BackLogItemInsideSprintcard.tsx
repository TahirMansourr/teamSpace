  ...
  return (
    <div className=" relative bg-white dark:bg-gray-800 rounded-lg shadow-md p-4 mb-4 transition-transform transform hover:scale-105 hover:cursor-pointer">
      ...
      <p className="text-gray-600 dark:text-gray-300 mb-2">
        {truncateText(backLogItem.description, 30)}
      </p>
      ...
      <div className="flex justify-between items-center text-sm text-gray-500 dark:text-gray-400 mb-2">
        <span>Estimated Effort: {backLogItem.estimatedEffort}h</span>
        <span>Priority: {backLogItem.priority}</span>
      </div>
      ...
      />
      <CreateBackLogItemModal initialValues={backLogItem} opened = {updateModalOpened} close={closeUpdateModal}/>
    </div>
  );
};
